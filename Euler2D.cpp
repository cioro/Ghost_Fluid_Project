...
Euler::U_state::U_state(double rho_arg, double moment_u_arg,double moment_v_arg, double energy_arg) : \
  rho(rho_arg), moment_u(moment_u_arg),moment_v(moment_v_arg), energy(energy_arg) {}
